...
$min_bulanangka=mysql_fetch_array(mysql_query("select min(bulanangka) as min_bulanangka from tanggal_cb"));
$max_bulanangka=mysql_fetch_array(mysql_query("select max(bulanangka) as max_bulanangka from tanggal_cb"));
$min_tahun=mysql_fetch_array(mysql_query("select min(tahun) as min_tahun from tanggal_cb"));
$max_tahun=mysql_fetch_array(mysql_query("select max(tahun) as max_tahun from tanggal_cb"));

?>
  <body class="hold-transition skin-blue sidebar-mini">
    <form action="?page=chartcb" method="post" name="postform">
...
$query=mysql_query("select * from tanggal_cb");
$jumlah=mysql_fetch_array(mysql_query("select sum(jumlah) as total from tanggal_cb"));
...
$query=mysql_query("select * from tanggal_cb where bulanangka between '$bulanangka_awal' and '$bulanangka_akhir' and tahun between '$tahun_awal' and '$tahun_akhir'");
$jumlah=mysql_fetch_array(mysql_query("select sum(jumlah) as total	 from tanggal_cb where bulanangka between '$bulanangka_awal' and '$bulanangka_akhir' and tahun between '$tahun_awal' and '$tahun_akhir' ORDER BY bulanangka ASC"));
    ...
    <script type="text/javascript">
      $(function() {
        Morris.Bar({
          ...
          data: [
            <?php
            $exec=mysql_query("select * from tanggal_cb where tahun between '$tahun_awal' and '$tahun_akhir' and bulanangka between '$bulanangka_awal' and '$bulanangka_akhir' ORDER BY bulanangka ASC");
    ...
    <script type="text/javascript">
      $(function() {
        Morris.Bar({
          ...
          data: [
            <?php
            $exec=mysql_query("select * from years_cb where tahun between '$tahun_awal' and '$tahun_akhir' ORDER BY tahun ASC");
            while($r=mysql_fetch_array($exec)){
            ?>
            {
            tahun: '<?php echo $r[1] ?>',
