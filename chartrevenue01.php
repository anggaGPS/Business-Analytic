...
$query=mysql_query("select * from view_revenue01 where bulanangka between '$bulanangka_awal' and '$bulanangka_akhir' and tahun between '$tahun_awal' and '$tahun_akhir' ORDER BY bulanangka ASC");
    ...
    <script type="text/javascript">
      $(function() {
        Morris.Bar({
          ...
          data: [
            <?php
            $exec=mysql_query("select * from view_revenue01 where tahun between '$tahun_awal' and '$tahun_akhir' and bulanangka between '$bulanangka_awal' and '$bulanangka_akhir' ORDER BY bulanangka ASC");
    ...
    <script type="text/javascript">
      $(function() {
        Morris.Bar({
          ...
          data: [
            <?php
            $exec=mysql_query("select * from view_revenue01years where tahun between '$tahun_awal' and '$tahun_akhir' ORDER BY tahun ASC");
            while($r=mysql_fetch_array($exec)){
            ?>
            {
            tahun: '<?php echo $r[1] ?>',
