    ...
    <div class="wrapper">
        ...
        <section class="content">
          <div class="row">
            <div class="col-xs-12">
              <div class="box">
			  <form enctype='multipart/form-data' action='?page=costumerbase' method='post'>
...
if(isset($_GET['mode'])=='delete'){
	 $misdn=$_GET['misdn'];
	 mysql_query("delete from tb_cb where misdn='$misdn'");
}
?>
                    <thead>
                      <tr>
	 ...
	 <?php
		$query=mysql_query("SELECT * FROM tb_cb");					

		while($row=mysql_fetch_assoc($query)){
			?>
			<tr>
							<td><?php echo $row['id'];?></td>
							<td><?php echo $row['misdn'];?></td>
							<td><?php echo $row['tanggal'];?></td>
						
				<td><a href="?page=icostumerbase&mode=delete&misdn=
				<?php echo $row['misdn'];?>" onClick="return confirm('Apakah Anda Yakin?')">
