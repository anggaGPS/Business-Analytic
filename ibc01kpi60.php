    ...
    <div class="wrapper">
        ...
        <section class="content">
          <div class="row">
            <div class="col-xs-12">
              <div class="box">
			  <form enctype='multipart/form-data' action='?page=bc01kpi60' method='post'>
...
if(isset($_GET['mode'])=='delete'){
	 $kota=$_GET['kota'];
	 mysql_query("delete from tb_bc01kpi60 where kota='$kota'");
}
?>
                    <thead>
                      <tr>
	 ...
	 $no=0;
		...
		while($row=mysql_fetch_assoc($query)){
			...
			<tr>
				...
				<td><a href="?page=ibc01kpi60&mode=delete&kota=
