...
//Script Upload File..
    ...
    while (($data = fgetcsv($handle, 1000, ",")) !== FALSE) {
        $import="INSERT into tb_revenue16 (id,toa,tanggal) values(NULL,'$data[0]','$data[1]')"; //data array sesuaikan dengan jumlah kolom pada CSV anda mulai dari “0” bukan “1”
...
<!-- Form Untuk Upload File CSV-->
   ...
   <a href="icostumerbase.php"><i class="fa fa-circle-o"></i>Back to -></a></li>
