...
$min_tanggal=mysql_fetch_array(mysql_query("select min(tanggal) as min_tanggal from view_bc01kpi60kota"));
$max_tanggal=mysql_fetch_array(mysql_query("select max(tanggal) as max_tanggal from view_bc01kpi60kota"));
$min_tahun=mysql_fetch_array(mysql_query("select min(tahun) as min_tahun from view_bc01kpi60kota"));
$max_tahun=mysql_fetch_array(mysql_query("select max(tahun) as max_tahun from view_bc01kpi60kota"));

?>
  <body class="hold-transition skin-blue sidebar-mini">
    <form action="?page=chartbc01kpi60" method="post" name="postform">
...
$query=mysql_query("select * from view_bc01kpi60kota");
...
$query=mysql_query("select * from view_bc01kpi60kota where bulanangka like $bulanangka and tahun like $tahun");
...
?>
            ...
            <div style="width:820px"class="col-md-6">
              ...
              <div class="box box-danger">
                <div class="box-header with-border">
                  <h3 class="box-title"> Persentase Baddebt dan Collection 01 - KPI 60</h3>
                  <div class="box-tools pull-right">
...
$(function() {
    Morris.Bar({
        ...
        data: [
        <?php
        $exec=mysql_query("select * from view_bc01kpi60kota where bulanangka like $bulanangka and tahun like $tahun");
        while($r=mysql_fetch_array($exec)){
        ?>
        {
            kota: '<?php echo $r[0] ?>',
            billing: <?php echo $r[2] ?>,
			tunggakan: <?php echo $r[4] ?>,
            collection: <?php echo $r[6] ?>
        },
        <?php
        }
        ?>
...
$(function() {
    Morris.Bar({
        ...
        {
            kota: '<?php echo $r[0] ?>',
            baddebt: <?php echo $r[7] *100?>,
            persen: <?php echo $r[8] *100?>
        },
        <?php
        }
        ?>
...
$(function() {
    Morris.Bar({
        ...
        data: [
        <?php
        $exec=mysql_query("select * from view_bc01kpi60 where bulanangka like $bulanangka and tahun like $tahun");
        while($r=mysql_fetch_array($exec)){
        ?>
        {
            kota: 'Jateng',
