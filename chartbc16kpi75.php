...
$min_tanggal=mysql_fetch_array(mysql_query("select min(tanggal) as min_tanggal from tb_bc16kpi75"));
$max_tanggal=mysql_fetch_array(mysql_query("select max(tanggal) as max_tanggal from tb_bc16kpi75"));
$min_tahun=mysql_fetch_array(mysql_query("select min(tahun) as min_tahun from tb_bc16kpi75"));
$max_tahun=mysql_fetch_array(mysql_query("select max(tahun) as max_tahun from tb_bc16kpi75"));

?>
  <body class="hold-transition skin-blue sidebar-mini">
    <form action="?page=chartbc16kpi75" method="post" name="postform">
...
$query=mysql_query("select * from tb_bc16kpi75");
...
$query=mysql_query("select * from tb_bc16kpi75 where tanggal like '$tanggal'");
...
?>
            ...
            <div style="width:820px"class="col-md-6">
              ...
              <div class="box box-danger">
                <div class="box-header with-border">
                  <h3 class="box-title"> Persentase Baddebt dan Collection 16 - KPI 75</h3>
                  <div class="box-tools pull-right">
...
$(function() {
    Morris.Bar({
        ...
        data: [
        <?php
        $exec=mysql_query("select * from tb_bc16kpi75 where tanggal like '$tanggal'");
...
$(function() {
    Morris.Bar({
        ...
        data: [
        <?php
        $exec=mysql_query("select * from view_bc16kpi75 where tanggal like '$tanggal'");
        while($r=mysql_fetch_array($exec)){
        ?>
        {
            kota: 'Jateng',
