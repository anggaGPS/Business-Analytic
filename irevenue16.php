    ...
    <div class="wrapper">
        ...
        <section class="content">
          <div class="row">
            <div class="col-xs-12">
              <div class="box">
			  <form enctype='multipart/form-data' action='?page=revenue16' method='post'>
...
if(isset($_GET['mode'])=='delete'){
	 $toa=$_GET['toa'];
	 mysql_query("delete from tb_revenue16 where toa='$toa'");
}
?>
                    <thead>
                      <tr>
	 ...
	 <?php
		$query=mysql_query("SELECT * FROM tb_revenue16");					
