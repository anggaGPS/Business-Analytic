    ...
    <div class="wrapper">
        ...
        <section class="content">
          <div class="row">
            <div class="col-xs-12">
              <div class="box">
			  <form enctype='multipart/form-data' action='?page=bc16kpi75' method='post'>
...
if(isset($_GET['mode'])=='delete'){
	 $kota=$_GET['kota'];
	 mysql_query("delete from tb_bc16kpi75 where kota='$kota'");
}
?>
                    <thead>
                      <tr>
	 ...
	 <?php
		...
		while($row=mysql_fetch_assoc($query)){
			...
			<tr>
				...
				<td><a href="?page=ibc16kpi75&mode=delete&kota=
