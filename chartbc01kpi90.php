...
$min_tanggal=mysql_fetch_array(mysql_query("select min(tanggal) as min_tanggal from tb_bc01kpi90"));
$max_tanggal=mysql_fetch_array(mysql_query("select max(tanggal) as max_tanggal from tb_bc01kpi90"));
$min_tahun=mysql_fetch_array(mysql_query("select min(tahun) as min_tahun from tb_bc01kpi90"));
$max_tahun=mysql_fetch_array(mysql_query("select max(tahun) as max_tahun from tb_bc01kpi90"));

?>
  <body class="hold-transition skin-blue sidebar-mini">
    <form action="?page=chartbc01kpi90" method="post" name="postform">
...
$query=mysql_query("select * from tb_bc01kpi90");
...
$query=mysql_query("select * from tb_bc01kpi90 where tanggal like '$tanggal'");
...
$(function() {
    Morris.Bar({
        ...
        data: [
        <?php
        $exec=mysql_query("select * from tb_bc01kpi90 where tanggal like '$tanggal'");
...
$(function() {
    Morris.Bar({
        ...
        data: [
        <?php
        $exec=mysql_query("select * from view_bc01kpi90 where tanggal like '$tanggal'");
        while($r=mysql_fetch_array($exec)){
        ?>
        {
            kota: 'Jateng',
