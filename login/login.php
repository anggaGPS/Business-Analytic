...
<html>
  <head>
    ...
    <div class="login-box">
	  ...
	  <img src="login2/assets/img/TSEL.png" alt="User Image">
        <a href="login/login.php"><b>Telkomsel</b>LTE</a>
      </div><!-- /.login-logo -->
      <div class="login-box-body">
        <p class="login-box-msg">Sign in to start your session</p>
          ...
          <div class="form-group has-feedback">
            ...
            <div class="col-xs-4">
             <input type="submit" value="Sign In" class="btn btn-primary btn-block btn-flat"></input>
            </div><!-- /.col -->
          </div>
			</form>
